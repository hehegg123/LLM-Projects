...
class Classification(BaseModel):
    sentiment: Literal['happy', 'neutral', 'sad'] = Field(description='sentiment of text')

    aggressiveness: int = Field(description="describe the aggressiveness of the text from 1 - 5")
